      ...
      <Box sx={{ p: 2 }}>
        ...
        <Box>
          ...
          <Paragraph>
            ...
            code <CodeIcon sx={{ color: "#da0064" }} /> and now, I am refocusing
            on web development where I can leverage my diverse industry
            background to create exceptional web user experiences, drive
            innovation, and deliver customer value.
          </Paragraph>
        </Box>
        <Box>
          <Typography component="h4" variant="h4" sx={{ my: 3 }}>
