    ...
    <Box>
      ...
      <Box>
        ...
        <Paragraph>
          ...
          brain-teasing puzzles like Sudoku and crosswords on the New York Times
          Games app to the more action-packed experience of video games like the
          Insomniac Spider-Man series on PS5.
        </Paragraph>
        <Paragraph>
          A fun fact about me: I only really enjoy Sudoku when it&apos;s set to
      ...
      <Box>
        ...
        <Paragraph>
          ...
          — it&apos;s my creative outlet for everything I&apos;m learning along
          the way.
        </Paragraph>
      </Box>
    </Box>
